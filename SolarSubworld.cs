...
namespace TUA
{
    public class SolarSubworld : Subworld
    {
		...
		public void ModifyGenerationPass(int seed, GenerationProgress customProgressObject)
        {
            ...
            AddGenerationPass("Tunnels", delegate (GenerationProgress progress)
            {
                for (int k = 0; k < (int)((double)Main.maxTilesX * 0.0015); k++)
                {
                    ...
                    for (int m = 0; m < 10; m++)
                    {
                        SolarSubworld.TileRunner(array[m], array2[m], (double)WorldGen.genRand.Next(5, 8), WorldGen.genRand.Next(6, 9), ModLoader.GetMod("TUA").TileType("SolarDirt"), true, -2f, -0.3f, false, true);
                        SolarSubworld.TileRunner(array[m], array2[m], (double)WorldGen.genRand.Next(5, 8), WorldGen.genRand.Next(6, 9), ModLoader.GetMod("TUA").TileType("SolarDirt"), true, 2f, -0.3f, false, true);
                    }
                }
            });
            ...
            AddGenerationPass("Rocks In Dirt", delegate (GenerationProgress progress)
            {
                ...
                {
                    SolarSubworld.TileRunner(WorldGen.genRand.Next(0, Main.maxTilesX), WorldGen.genRand.Next(0, (int)WorldGen.worldSurfaceLow + 1), (double)WorldGen.genRand.Next(4, 15), WorldGen.genRand.Next(5, 40), ModLoader.GetMod("TUA").TileType("SolarRock"), false, 0f, 0f, false, true);
                }
                for (int l = 0; l < (int)((double)(Main.maxTilesX * Main.maxTilesY) * 0.0002); l++)
                {
                    ...
                    SolarSubworld.TileRunner(num, num2, (double)WorldGen.genRand.Next(4, 10), WorldGen.genRand.Next(5, 30), ModLoader.GetMod("TUA").TileType("SolarRock"), false, 0f, 0f, false, true);
                }
                for (int m = 0; m < (int)((double)(Main.maxTilesX * Main.maxTilesY) * 0.0045); m++)
                {
                    SolarSubworld.TileRunner(WorldGen.genRand.Next(0, Main.maxTilesX), WorldGen.genRand.Next((int)worldSurfaceHigh, (int)rockLayerHigh + 1), (double)WorldGen.genRand.Next(2, 7), WorldGen.genRand.Next(2, 23), ModLoader.GetMod("TUA").TileType("SolarRock"), false, 0f, 0f, false, true);
                }
            });
            AddGenerationPass("Dirt In Rocks", delegate (GenerationProgress progress)
            {
                ...
                {
                    SolarSubworld.TileRunner(WorldGen.genRand.Next(0, Main.maxTilesX), WorldGen.genRand.Next((int)rockLayerLow, Main.maxTilesY), (double)WorldGen.genRand.Next(2, 6), WorldGen.genRand.Next(2, 40), ModLoader.GetMod("TUA").TileType("SolarDirt"), false, 0f, 0f, false, true);
                }
            });
            ...
            AddGenerationPass("Small Holes", delegate (GenerationProgress progress)
            {
                ...
                for (int k = 0; k < (int)((double)(Main.maxTilesX * Main.maxTilesY) * 0.0015); k++)
                {
                    ...
                    SolarSubworld.TileRunner(WorldGen.genRand.Next(0, Main.maxTilesX), WorldGen.genRand.Next((int)worldSurfaceHigh, Main.maxTilesY), (double)WorldGen.genRand.Next(2, 5), WorldGen.genRand.Next(2, 20), type, false, 0f, 0f, false, true);
                    SolarSubworld.TileRunner(WorldGen.genRand.Next(0, Main.maxTilesX), WorldGen.genRand.Next((int)worldSurfaceHigh, Main.maxTilesY), (double)WorldGen.genRand.Next(8, 15), WorldGen.genRand.Next(7, 30), type, false, 0f, 0f, false, true);
                }
            });
            AddGenerationPass("Dirt Layer Caves", delegate (GenerationProgress progress)
            {
                ...
                for (int k = 0; k < (int)((double)(Main.maxTilesX * Main.maxTilesY) * 3E-05); k++)
                {
                    ...
                    if (rockLayerHigh <= (double)Main.maxTilesY)
                    {
                        ...
                        SolarSubworld.TileRunner(WorldGen.genRand.Next(0, Main.maxTilesX), WorldGen.genRand.Next((int)WorldGen.worldSurfaceLow, (int)rockLayerHigh + 1), (double)WorldGen.genRand.Next(5, 15), WorldGen.genRand.Next(30, 200), type, false, 0f, 0f, false, true);
                    }
                }
            });
            AddGenerationPass("Rock Layer Caves", delegate (GenerationProgress progress)
            {
                ...
                for (int k = 0; k < (int)((double)(Main.maxTilesX * Main.maxTilesY) * 0.00013); k++)
                {
                    ...
                    if (rockLayerHigh <= (double)Main.maxTilesY)
                    {
                        ...
                        SolarSubworld.TileRunner(WorldGen.genRand.Next(0, Main.maxTilesX), WorldGen.genRand.Next((int)rockLayerHigh, Main.maxTilesY), (double)WorldGen.genRand.Next(6, 20), WorldGen.genRand.Next(50, 300), type, false, 0f, 0f, false, true);
                    }
                }
            });
            AddGenerationPass("Surface Caves", delegate (GenerationProgress progress)
            {
                ...
                for (int k = 0; k < (int)((double)Main.maxTilesX * 0.002); k++)
                {
                    ...
                    while ((double)num < worldSurfaceHigh)
                    {
                        ...
                        {
                            SolarSubworld.TileRunner(i2, num, (double)WorldGen.genRand.Next(3, 6), WorldGen.genRand.Next(5, 50), -1, false, (float)WorldGen.genRand.Next(-10, 11) * 0.1f, 1f, false, true);
                            break;
                        }
                        num++;
                    }
                ...
                for (int l = 0; l < (int)((double)Main.maxTilesX * 0.0007); l++)
                {
                    ...
                    while ((double)num2 < worldSurfaceHigh)
                    {
                        ...
                        {
                            SolarSubworld.TileRunner(i2, num2, (double)WorldGen.genRand.Next(10, 15), WorldGen.genRand.Next(50, 130), -1, false, (float)WorldGen.genRand.Next(-10, 11) * 0.1f, 2f, false, true);
                            break;
                        }
                        num2++;
                    }
                ...
                for (int m = 0; m < (int)((double)Main.maxTilesX * 0.0003); m++)
                {
                    ...
                    while ((double)num3 < worldSurfaceHigh)
                    {
                        ...
                        {
                            SolarSubworld.TileRunner(i2, num3, (double)WorldGen.genRand.Next(12, 25), WorldGen.genRand.Next(150, 500), -1, false, (float)WorldGen.genRand.Next(-10, 11) * 0.1f, 4f, false, true);
                            SolarSubworld.TileRunner(i2, num3, (double)WorldGen.genRand.Next(8, 17), WorldGen.genRand.Next(60, 200), -1, false, (float)WorldGen.genRand.Next(-10, 11) * 0.1f, 2f, false, true);
                            SolarSubworld.TileRunner(i2, num3, (double)WorldGen.genRand.Next(5, 13), WorldGen.genRand.Next(40, 170), -1, false, (float)WorldGen.genRand.Next(-10, 11) * 0.1f, 2f, false, true);
                            break;
                        }
                        num3++;
                    }
                ...
                for (int n = 0; n < (int)((double)Main.maxTilesX * 0.0004); n++)
                {
                    ...
                    while ((double)num4 < worldSurfaceHigh)
                    {
                        ...
                        {
                            SolarSubworld.TileRunner(i2, num4, (double)WorldGen.genRand.Next(7, 12), WorldGen.genRand.Next(150, 250), -1, false, 0f, 1f, true, true);
                            break;
                        }
                        num4++;
                    }
                ...
                while ((float)num6 < 5f * num5)
                {
                    try
                    {
                        SolarSubworld.Caverer(WorldGen.genRand.Next(100, Main.maxTilesX - 100), WorldGen.genRand.Next((int)Main.rockLayer, Main.maxTilesY - 400));
                    }
                    catch
                    {
                    }
		...
		public static void Caverer(int X, int Y)
		{
			...
			if (num == 0)
			{
				...
				{
					vector = SolarSubworld.digTunnel(vector.X, vector.Y, num3, num4, WorldGen.genRand.Next(6, 20), WorldGen.genRand.Next(4, 9), false);
					...
					Vector2 vector2 = SolarSubworld.digTunnel(vector.X, vector.Y, num5, num6, WorldGen.genRand.Next(30, 50), WorldGen.genRand.Next(3, 6), false);
					SolarSubworld.TileRunner((int)vector2.X, (int)vector2.Y, (double)WorldGen.genRand.Next(10, 20), WorldGen.genRand.Next(5, 10), -1, false, 0f, 0f, false, true);
				}
				return;
			}
			if (num == 1)
			{
				...
				{
					vector3 = SolarSubworld.digTunnel(vector3.X, vector3.Y, num8, num9, WorldGen.genRand.Next(5, 15),
