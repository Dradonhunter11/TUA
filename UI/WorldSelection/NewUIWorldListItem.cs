...
//namespace TUA.UI.WorldSelection
//{
...
//            string text = this._data.IsExpertMode ? Language.GetTextValue("UI.Expert") : Language.GetTextValue("UI.Normal");
//            text = _TUAWorldData.GetBool("UltraMode") ? Language.GetTextValue("UI.UltraMode") :
//                (this._data.IsExpertMode) ? Language.GetTextValue("UI.Expert") : Language.GetTextValue("UI.Normal");
