...
using TUA.Items.Tiles.Wasteland;

namespace TUA.Items.Tools
{
    class WastestoneWaraxe : ModItem
    {
        ...
        public override void AddRecipes()
        {
            ...
            furnace.AddIngredient(ModContent.ItemType<WastestoneIngot_Item>(), 15);
            furnace.SetCostAndCookTime(500);
            furnace.SetResult(ModContent.ItemType<WastestoneWaraxe>());
            furnace.AddRecipe();
        }
