    ...
    public class Eye_of_Apocalypse : ModNPC
    {
        ...
        public override void OnHitPlayer(Player target, int damage, bool crit)
        {
            if (Main.myPlayer == target.whoAmI && !playersHit.Contains(target.whoAmI) && target.statLife < target.statLife * .2)
            {
                ...
                {
                    case 0:
                        Main.NewText($"<{npc.GivenName}> No offense {target.name}, but you're struggling to keep up. Don't tell me you're out already!?");
                        break;
                    case 1:
                    ...
                    case 4:
                        ...
                        break;
                    default:
                        Main.NewText($"<{npc.GivenName}> Tell me, you poor human, how does it feel to know that you'll never reach my caliber of power?");
                        break;
                }
