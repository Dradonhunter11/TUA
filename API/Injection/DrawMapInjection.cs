    ...
    class DrawMapInjection
    {
        ...
        public static void inject()
        {
            MethodInfo OriginalDrawMap =
                StaticManager<Type>.GetItem("TMain").GetMethod("DrawMap", BindingFlags.Instance | BindingFlags.Public | BindingFlags.Static | BindingFlags.NonPublic);
            ...
            PostDrawFullscreenMap = StaticManager<Type>.GetItem("TMain").Assembly.GetType("Terraria.ModLoader.ModHooks").GetMethod("PostDrawFullscreenMap", BindingFlags.Static | BindingFlags.NonPublic);
        ...
        {
            MethodInfo DrawPlayerHead = StaticManager<Type>.GetItem("TMain").Assembly.GetType("Terraria.Main")
        .GetMethod("DrawPlayerHead", BindingFlags.Instance | BindingFlags.NonPublic);

            MethodInfo DrawMap_FindChestName = StaticManager<Type>.GetItem("TMain").Assembly.GetType("Terraria.Main")
                .GetMethod("DrawMap_FindChestName", BindingFlags.Instance | BindingFlags.NonPublic);


            FieldInfo mapDeathTextureInfo =
                StaticManager<Type>.GetItem("TMain").GetField("mapDeathTexture", BindingFlags.Instance | BindingFlags.NonPublic);
            Texture2D mapDeathTexture = (Texture2D)mapDeathTextureInfo.GetValue(Main.instance);

            FieldInfo mapBG1TextureInfo = StaticManager<Type>.GetItem("TMain").GetField("mapBG1Texture", BindingFlags.Instance | BindingFlags.NonPublic);
            Texture2D mapBG1Texture = (Texture2D)mapDeathTextureInfo.GetValue(Main.instance);

            FieldInfo mapBG2TextureInfo = StaticManager<Type>.GetItem("TMain").GetField("mapBG2Texture", BindingFlags.Instance | BindingFlags.NonPublic);
            Texture2D mapBG2Texture = (Texture2D)mapDeathTextureInfo.GetValue(Main.instance);

            FieldInfo mapBG3TextureInfo = StaticManager<Type>.GetItem("TMain").GetField("mapBG3Texture", BindingFlags.Instance | BindingFlags.NonPublic);
            Texture2D mapBG3Texture = (Texture2D)mapDeathTextureInfo.GetValue(Main.instance);

            FieldInfo mapBG4TextureInfo = StaticManager<Type>.GetItem("TMain").GetField("mapBG4Texture", BindingFlags.Instance | BindingFlags.NonPublic);
            Texture2D mapBG4Texture = (Texture2D)mapDeathTextureInfo.GetValue(Main.instance);

            FieldInfo mapBG5TextureInfo = StaticManager<Type>.GetItem("TMain").GetField("mapBG5Texture", BindingFlags.Instance | BindingFlags.NonPublic);
            Texture2D mapBG5Texture = (Texture2D)mapDeathTextureInfo.GetValue(Main.instance);

            FieldInfo mapBG6TextureInfo = StaticManager<Type>.GetItem("TMain").GetField("mapBG6Texture", BindingFlags.Instance | BindingFlags.NonPublic);
            Texture2D mapBG6Texture = (Texture2D)mapDeathTextureInfo.GetValue(Main.instance);

            FieldInfo mapBG7TextureInfo = StaticManager<Type>.GetItem("TMain").GetField("mapBG7Texture", BindingFlags.Instance | BindingFlags.NonPublic);
            Texture2D mapBG7Texture = (Texture2D)mapDeathTextureInfo.GetValue(Main.instance);

            FieldInfo mapBG8TextureInfo = StaticManager<Type>.GetItem("TMain").GetField("mapBG8Texture", BindingFlags.Instance | BindingFlags.NonPublic);
            Texture2D mapBG8Texture = (Texture2D)mapDeathTextureInfo.GetValue(Main.instance);

            FieldInfo mapBG9TextureInfo = StaticManager<Type>.GetItem("TMain").GetField("mapBG9Texture", BindingFlags.Instance | BindingFlags.NonPublic);
            Texture2D mapBG9Texture = (Texture2D)mapDeathTextureInfo.GetValue(Main.instance);

            FieldInfo mapBG10TextureInfo = StaticManager<Type>.GetItem("TMain").GetField("mapBG10Texture", BindingFlags.Instance | BindingFlags.NonPublic);
            Texture2D mapBG10Texture = (Texture2D)mapDeathTextureInfo.GetValue(Main.instance);

            FieldInfo mapBG11TextureInfo = StaticManager<Type>.GetItem("TMain").GetField("mapBG11Texture", BindingFlags.Instance | BindingFlags.NonPublic);
            Texture2D mapBG11Texture = (Texture2D)mapDeathTextureInfo.GetValue(Main.instance);

            FieldInfo mapBG12TextureInfo = StaticManager<Type>.GetItem("TMain").GetField("mapBG12Texture", BindingFlags.Instance | BindingFlags.NonPublic);
            Texture2D mapBG12Texture = (Texture2D)mapDeathTextureInfo.GetValue(Main.instance);

            FieldInfo mapBG13TextureInfo = StaticManager<Type>.GetItem("TMain").GetField("mapBG13Texture", BindingFlags.Instance | BindingFlags.NonPublic);
            Texture2D mapBG13Texture = (Texture2D)mapDeathTextureInfo.GetValue(Main.instance);

            FieldInfo mapBG14TextureInfo = StaticManager<Type>.GetItem("TMain").GetField("mapBG14Texture", BindingFlags.Instance | BindingFlags.NonPublic);
            Texture2D mapBG14Texture = (Texture2D)mapDeathTextureInfo.GetValue(Main.instance);

            FieldInfo mapBG15TextureInfo = StaticManager<Type>.GetItem("TMain").GetField("mapBG15Texture", BindingFlags.Instance | BindingFlags.NonPublic);
