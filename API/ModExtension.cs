            ...
            for (int j = 0; j < 255; j++)
            {
                if (Main.player[j].active && !Main.player[j].dead)
                {
                    ...
                    if (Main.player[j].active && !Main.player[j].dead && Main.player[j].activeNPCs < (float)maxSpawns && Main.rand.Next(spawnRate) == 0)
                    {
                        ...
                        safeRangeX = (int)((double)(NPC.sWidth / 16) * 0.52);
                        safeRangeY = (int)((double)(NPC.sHeight / 16) * 0.52);
                        if (Main.player[j].inventory[Main.player[j].selectedItem].type == 1254 || Main.player[j].inventory[Main.player[j].selectedItem].type == 1299 || Main.player[j].scope)
                        {
                            ...
                            safeRangeX += (int)((double)(NPC.sWidth / 16) * 0.5 / (double)num8);
                            safeRangeY += (int)((double)(NPC.sHeight / 16) * 0.5 / (double)num8);
                        }
                        ...
                        int num13 = (int)(Main.player[j].position.X / 16f) - safeRangeX;
                        int num14 = (int)(Main.player[j].position.X / 16f) + safeRangeX;
                        int num15 = (int)(Main.player[j].position.Y / 16f) - safeRangeY;
                        int num16 = (int)(Main.player[j].position.Y / 16f) + safeRangeY;
                        if (num9 < 0)
                        {
                            num9 = 0;
                        }
                    ...
                    if (flag13)
                    {
                        ...
                        for (int num24 = 0; num24 < 255; num24++)
                        {
                            ...
                            {
                                Rectangle rectangle2 = new Rectangle((int)(Main.player[num24].position.X + (float)(Main.player[num24].width / 2) - (float)(NPC.sWidth / 2) - (float)safeRangeX), (int)(Main.player[num24].position.Y + (float)(Main.player[num24].height / 2) - (float)(NPC.sHeight / 2) - (float)safeRangeY), NPC.sWidth + safeRangeX * 2, NPC.sHeight + safeRangeY * 2);
